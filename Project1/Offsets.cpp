...
void Offsets::GetOffsets()
{
	...
	offsets.DT_BasePlayer.m_hConstraintEntity = NetVarManager::GetOffset(tables, "DT_BasePlayer", "m_hConstraintEntity");
	offsets.DT_BasePlayer.m_flMaxspeed = NetVarManager::GetOffset(tables, "DT_BasePlayer", "m_flMaxspeed");
